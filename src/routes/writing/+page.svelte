...
<ul>
  ...
  <li>
    <a
      ...
      >8.6.23 the deep connections between soil and greenhouse gas emissions
    </a>
  </li>
  <li>
    <a
      href="https://docs.google.com/document/d/1aw5Nn2ph2TABpfSMn1JqiJZblZ7yP6rOiH7Hd4tXpQY/edit?usp=sharing"
      >4.21.23 the role of mycorrhizal fungi in plant growth and development
    </a>
  </li>
  <li>
    <a href="./writing/spectrometer">07.23.23 deep dives on spectrometers</a>
  </li>
  <li>
    <a
      href="https://docs.google.com/presentation/d/1Z8ebEN76z4dJMa5gXSBFIMoTtN-JtdcPauNKf1b8Y-g/edit?usp=sharing"
      >5.2.23 metagenomic time series analysis on nitrate reduction pathway in
      cattle gut</a
    >
  </li>
  <li>
    <a
      ...
      >4.30.23 how synthetic fertilizer impacts microbial diversity (see the
      visual beauty of microbes!)
    </a>
  </li>
  <li>
    <a href="./writing/agonpublichealth"
      >the impacts of conventional agriculture on public health</a
    >
  </li>
  <li>
    <a
