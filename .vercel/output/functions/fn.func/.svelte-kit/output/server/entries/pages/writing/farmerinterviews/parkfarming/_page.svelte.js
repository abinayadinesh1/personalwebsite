...
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<h1 data-svelte-h="svelte-1ajilk8">Park Farming</h1> <p data-svelte-h="svelte-1aqlmww">Not a farm, a decades long experiment with regenerative farming.</p> <p data-svelte-h="svelte-15rfutm">This was one of the most transformational calls I&#39;ve had, with such an
  ...
  farmer I was talking to, to protect his identity.</p> <h2 id="surprises-to-me-" data-svelte-h="svelte-1esky6d">Surprises to me:</h2> <ul data-svelte-h="svelte-1gkbmg1"><li>where A lives, there are only 8 houses in 10 miles. he can go 2-3 weeks
    ...
    of holistic management.</li></ul> <p data-svelte-h="svelte-k9bc9o"><strong>What is the main problem you see that prevents conventional farmers from
  ...
  (sector), but not another.</p> <p data-svelte-h="svelte-knqgqj">Universities, state, corportions, AND the CONSUMER (consumer hesitates to pay
  ...
  less or the farmer can&#39;t grow as much as he transitions?&quot;.</p> <p data-svelte-h="svelte-1xi61vf">What farmers really want is better INSURANCE. They want an umbrella to protect
  ...
  microbacteria. So, it&#39;s got to be all or nothing.</p> <p data-svelte-h="svelte-1i666zw">There isn&#39;t a lot of data to support regen ag. Professors will kill (him)
  - but too much of research is deductive reasoning: asking questions like,
  &quot;what is the impact of nitrogen on soil?&quot;. It&#39;s too piecemeal.</p> <p data-svelte-h="svelte-eytdda">On A farm, he considers everything. Their borders, their timing, their
  ...
  are optimizing for crop yield, harvest by harvest.</p> <p data-svelte-h="svelte-hyieue">A major problem of our system is that everything instant gratification.
  Landowners want as much money as they can every acre every year. If farmers
  aren&#39;t yielding high, the lease owners will give the land to someone else.</p> <p data-svelte-h="svelte-1lcc1b0"><strong>What is your background? Did you have any formal training in agriculture?</strong>
  ...
  twice.</p> <p data-svelte-h="svelte-1ohqqo6">He plays with the ideas of minimalism vs manipulation, which is what most
  farmers do. They sterilize the whole environment and create what you want
  through inputs, with no trust in the natural system.</p> <p data-svelte-h="svelte-17t8hpc">The best way to start the transition to regeneration is to get away from
  ...
  think.</p> <p data-svelte-h="svelte-10to6in">He started regen farming 37 years ago, and had done everything with no support
  ...
  schools to share his knowledge and progress the field of regen ag.</p> <p data-svelte-h="svelte-1bvjgpu"><strong>What is the main motivator for a farmer to start the change, from
    conventional to regen?</strong></p> <ol data-svelte-h="svelte-cgxadu"><li>Farmers need to be convinced, with all 6 of their senses, what regen ag will
    do for them. If they can see things, walk on the ground, smell the ground
    and put their shovels in to see the soil, they can start to understand.</li></ol> <p data-svelte-h="svelte-whu0lt"><em>a huge surprise to me:</em> some conventional farmers dont even see worms in
  their soils. they dont remember, know, or feel what it means to have healthy, microbial
  enriched soils.</p> <ol data-svelte-h="svelte-eyvyyj"><li>farmers need to see numbers. research needs to be done that quantifies just <strong>how much</strong>
    ...
    <strong>on its own, regenerative farming doesnt increase yield, but it reduces
      the bottom line of money spent to run the farm.</strong> who cares how you make your dollar?</li></ol> <p data-svelte-h="svelte-7auuw7">farmers need to see hard numbers from someone they trust. It can take 3-4
  years for the ground to change, so they cant depend on the instantaneous
  result anymore.</p> <p data-svelte-h="svelte-1olohyw"><strong>how bad is tilling for our soils? if so, why does it have such an extensive
  ...
  matters at scale: no-till on any size is almost nonexistent.</p> <p data-svelte-h="svelte-1m4qgd9">On his farm, he uses targetting tilling: only killing what you need to and
  ...
  thing holding them back from going no-till.</p> <p data-svelte-h="svelte-dt87u7"><strong>*Quick reflection</strong>: These write-ups are to make my
