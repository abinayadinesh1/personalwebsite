...
const css = {
  code: 'body.svelte-hnw7hg{background-image:url("bg.jpg")}',
  map: null
};
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<body class="svelte-hnw7hg" data-svelte-h="svelte-xqt5o9"><h1>why do economies at scale break down with agriculture?</h1> <h2>tldr;</h2> <ul><li>Everyone says economies of scale helps buisinesses boom and are usually
    ...
    what next? Shipping fertile soil from mars? food shortages around the world?</p> </body>`;
});
export {
  Page as default
};
