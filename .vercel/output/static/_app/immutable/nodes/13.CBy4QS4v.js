import{s as n,n as i}from"../chunks/scheduler.Cu-e96pa.js";import{S as s,i as u,c as h,a as l,m as c,t as m,b as p,d as f}from"../chunks/index.DvinRJN7.js";import{S as d}from"../chunks/SvelteMarkdown.B2H9SMJi.js";function y(r){let e,o;return e=new d({props:{source:r[0]}}),{c(){h(e.$$.fragment)},l(t){l(e.$$.fragment,t)},m(t,a){c(e,t,a),o=!0},p:i,i(t){o||(m(e.$$.fragment,t),o=!0)},o(t){p(e.$$.fragment,t),o=!1},d(t){f(e,t)}}}function g(r){return[`
...
**Braking (hard) is a form of discontinuity.** For passengers, it can be one of the most uncomfortable things to experience. They jolt forward, often unexpectedly, and are more prone to getting carsick. If you want to be the most loved driver in your friend group, you should learn how to drive without slamming the brakes. 

It’s silly, but I’ve been preparing my whole life for how to do this. Growing up, my bike’s brakes always made a terrible sound every time I hit them, so I RL'ed myself into never touching them. It is pretty simple to do this in cars, but just takes practice. 
...
4. TLDR: minimize jerk.`]}class k extends s{constructor(e){super(),u(this,e,g,y,n,{})}}export{k as component};
