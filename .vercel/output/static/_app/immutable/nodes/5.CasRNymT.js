import{s as r,e as n,c as l,g as c,f as h,i as d,n as o,d as u}from"../chunks/scheduler.alZtLdMt.js";import{S as m,i as f}from"../chunks/index.B9n9Ww45.js";function p(i){let e,a=`<h1>why do economies at scale break down with agriculture?</h1> <h2>tldr;</h2> <ul><li>Everyone says economies of scale helps buisinesses boom and are usually
      ...
      land.</li> <li>But maybe, there are reasons why it&#39;ll fail in the long run.</li></ul> <p>The central thesis of &quot;economies of scale&quot; is once the fixed costs are taken
    ...
    better.</p> <p>In conventional agriculture, start with a product like Tomato. You can only
    ...
    volume. Conventional agriculture has grown to <a href="https://css.umich.edu/publications/factsheets/food/us-food-system-factsheet">feed over 65% of our country</a>.</p> <p>According to the world bank, conventional agriculture also accounts for 70 -
    ...
    less people and send people to highly concentrated towns/cities.</p> <p>Obviously, conventional agriculture is pivotal to us being here and they
    benefit largely economies of scale.</p> <p>However, the major inputs to agriculture actually are deeconomies of scale.
    ...
    the more fertilizer is needed the next year.</p> <p>Many farmers have realized that you cant grow the same crop on the same
    ...
    actually led to lower profits.</p> <p>When corporate farms deplete the fertility of their soil or suffer from
    ...
    farmland in its tracks.</p> <p>doing this across America, Latin America, Africa, India and more means you
    ...
    what next? Shipping fertile soil from mars? food shortages around the world?</p>`;return{c(){e=n("body"),e.innerHTML=a,this.h()},l(t){e=l(t,"BODY",{class:!0,"data-svelte-h":!0}),c(e)!=="svelte-xqt5o9"&&(e.innerHTML=a),this.h()},h(){h(e,"class","svelte-hnw7hg")},m(t,s){d(t,e,s)},p:o,i:o,o,d(t){t&&u(e)}}}class v extends m{constructor(e){super(),f(this,e,null,p,r,{})}}export{v as component};
